  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="mb-4 flex items-center gap-2">
            ...
            <div>
            <h1 className="block text-gray-700 text-2xl font-bold" htmlFor="name">
            {user?.displayName}
            </h1>
            <p>{user?.email}</p>
            </div>
        ...
        <form onSubmit={handleAddReview}>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              className="w-full px-3 h-40 py-2 border rounded-lg focus:outline-none focus:border-blue-500"
              required
            ></textarea>
          </div>
